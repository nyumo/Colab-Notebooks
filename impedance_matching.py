...
sus304 = [7.93, 4.58, 1.49] #Marsh, 1980
...
print(data_frame)
#csv保存
save_name = dt_now.strftime("%Y-%m-%d_%H-%M-%S_") + f'IMtiO2-{material}'
...
data_frame.plot(x = 'Up', y = f'{material}_0', color = 'black', ax = ax)             #プロット 
data_frame.plot(x = 'Up', y = f'{material}_1', color = 'black', ax = ax)            #プロット 
